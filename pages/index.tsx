      ...
      <div className="text-left px-9 sm:px-12 md:px-24 lg:px-36 xl:px-48 py-5 md:py-10 overflow-hidden">
         ...
         <div className="grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:max-w-none lg:space-x-8 lg:items-center">
            <div className="mr-auto place-self-center lg:col-span-7">
               ...
               >
                  Tired of using StudentVue? Grade Melon is an all new third
                  party app to help you stay in control of your grades. It
                  allows any student using Synergy StudentVue to login to check
                  their schedule and calculate their grades.
               </motion.p>
            ...
            <div className="hidden lg:mt-0 lg:col-span-5   dark:block">
               <motion.img
                  initial={{ y: 50, opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                  transition={{ delay: 0.2, duration: 0.5 }}
         ...
         <div className="py-8 mx-auto max-w-screen-xl sm:py-16 mb-10">
            <div className="max-w-screen-md mb-8 lg:mb-16">
               ...
               >
                  Grade Melon is a third party app that allows you to stay in
                  control of your grades. It allows any student using Synergy
                  StudentVue to login to check their schedule and calculate
                  their grades.
               </motion.p>
            </div>
         ...
         <div className="gap-8 items-center py-8 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 ">
            <div className="mt-4 md:mt-0">
               ...
               >
                  Grade Melon is completely open source! You can find the source
                  code on our Github. We are commited to maintain transparency
                  with our users.
               </motion.p>
               <motion.div
                  initial={{ x: 0, opacity: 0 }}
         ...
         >
            If you have bug reports/suggestions, feel free to contact us by
            sending an email!
         </motion.p>
